...
from system_prompt_laravel import system_prompt

def initialize_llm():
    """
    Initialize the Groq LLM with Llama 3.3-70B model
...
def evaluate_candidates(job_description, detailed_applications):
    """
    Evaluate candidates using LLM and categorize them with robust error handling
    """
        ...
        for attempt in range(max_retries):
            try:
                ...
                if attempt < max_retries - 1:
                    ...
                    with open('failed_candidates.json', 'a') as f:
                        json.dump({
...
def main():
    ...
    os.remove("evaluation_progress.json")
